    ...
    it('Cenário válido - Valida um CEP do ACRE, capital RIO BRANCO.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('69900430-23051')
    ...
    it('Cenário válido - Valida um CEP de ALAGOAS, capital MACEIÓ.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('57030170-23051')
    ...
    it('Cenário válido - Valida um CEP do AMAPÁ, capital MACAPÁ.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('68900071-23051')
    ...
    it('Cenário válido - Valida um CEP do AMAZONAS, capital MANAUS.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('69063130-23051')
    ...
    it('Cenário válido - Valida um CEP da BAHIA, capital SALVADOR.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('40015140-23051')
    ...
    it('Cenário válido - Valida um CEP do CEARÁ, capital FORTALEZA.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('60765065-23051')
    ...
    it('Cenário válido - Valida um CEP do DISTRITO FEDERAL, capital BRASÍLIA.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('71691024-23051')
    ...
    it('Cenário válido - Valida um CEP do ESPÍRITO SANTO, capital VITÓRIA.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('29056215-23051')
    ...
    it('Cenário válido - Valida um CEP de GOIÁS, capital GOIÂNIA.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('74650010-23051')
    ...
    it('Cenário válido - Valida um CEP do MARANHÃO, capital SÃO LUIS.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('65010400-23051')
    ...
    it('Cenário válido - Valida um CEP do MATOGROSSO, capital CUIABÁ.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('78065060-23051')
    ...
    it('Cenário válido - Valida um CEP do MATOGROSSO DO SUL, capital CAMPO GRANDE.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('79002430-23051')
    ...
    it('Cenário válido - Valida um CEP de MINAS GERAIS, capital BELO HORIZONTE.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('30150160-23051')
    ...
    it('Cenário válido - Valida um CEP do PARÁ, capital BELÉM.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('66010020-23051')
    ...
    it('Cenário válido - Valida um CEP da PARAÍBA, capital JOÃO PESSOA.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('58010020-23051')
    ...
    it('Cenário válido - Valida um CEP do PARANÁ, capital CURITIBA.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('80010160-23051')
    ...
    it('Cenário válido - Valida um CEP do PERNANBUCO, capital RECIFE.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('50610120-23051')
    ...
    it('Cenário válido - Valida um CEP do PIAUÍ, capital TERESINA.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('64001230-23051')
    ...
    it('Cenário válido - Valida um CEP do RIO DE JANEIRO, capital RIO DE JANEIRO.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('20010000-23051')
    ...
    it('Cenário válido - Valida um CEP do RIO GRANDE DO NORTE, capital NATAL.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('59010100-23051')
    ...
    it('Cenário válido - Valida um CEP do RIO GRANDE DO SUL, capital PORTO ALEGRE.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('90030140-23051')
    ...
    it('Cenário válido - Valida um CEP de RONDÔNIA, capital PORTO VELHO.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('76802420-23051')
    ...
    it('Cenário válido - Valida um CEP de RORAIMA, capital BOA VISTA.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('88010090-23051')
    ...
    it('Cenário válido - Valida um CEP de SANTA CATARINA, capital FLORIANÓPOLIS.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('69301000-23051')
    ...
    it('Cenário válido - Valida um CEP de SÃO PAULO, capital SÃO PAULO.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('01001000-23051')
    ...
    it('Cenário válido - Valida um CEP de SERGIPE, capital ARACAJU.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('49010350-23051')
    ...
    it('Cenário válido - Valida um CEP do TOCANTIS, capital PALMAS.', () => {
        ...
        cy.request({
            ...
            .then((response) => {
                ...
                expect(response.body.id).to.equal('77002000-23051')
